  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience LOGISTIK - Your comprehensive solution for efficient and reliable Inventory Management. Streamline your operations, optimize storage and distribution, and revolutionize your business."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience LOGISTIK - Your comprehensive solution for efficient and reliable Inventory Management. Streamline your operations, optimize storage and distribution, and revolutionize your business.`}
            </Text>
            <Box
